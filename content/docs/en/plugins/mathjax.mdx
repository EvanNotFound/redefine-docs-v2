...
description: You can use the **[hexo-filter-mathjax](https://github.com/next-theme/hexo-filter-mathjax/)** plugin to write mathematical formulas using LaTeX syntax in your articles.
---
