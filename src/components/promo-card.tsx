		...
		<div className="w-full opacity-60 dark:opacity-80 hover:opacity-100">
			<AnimatePresence>
				<motion.a
					...
					className={
						"border border-zinc-200 dark:border-zinc-800 p-2 rounded-lg w-full my-2 bg-white dark:bg-zinc-900 flex flex-col gap-1  hover:opacity-100 shadow-none transition-all hover:shadow-sm relative group cursor-pointer"
					}
				...
				>
					...
					>
						<span className="text-sm">ChatGPT Plus 共享</span>
						<span
							className={
