...
支持的服务分别为：`aliyun`, `unpkg`, `jsdelivr`, `personal`，推荐使用 `aliyun`。
...
cdn:
  enable: true
  provider: aliyun # unpkg, jsdelivr, aliyun, personal
```
## 特别说明

`personal` 是由本人自费的阿里云OSS，如使用此源，有能力的话，麻烦[捐助](https://donate.ohevan.com)一些，阿里云OSS很烧钱，就算是一块两块的捐助也能维持得更久一些。感谢！