...
<div className="home-content">
  <div className="content-container">
    ...
    <p className="subtitle">
      <Link className={styles.cta} href="/introduction">快速开始 <span>→</span></Link>
    </p>
  </div>
    ...
    <div className="content-container">
      <Features>
        ...
        <Feature index={2} id="highlighting-card" href="/docs/guide/syntax-highlighting">
          ...
          <p>安装 `hexo-filter-mermaid-diagrams` 插件后，能完美支持 Mermaid JS 流程图显示。</p>
        </Feature>
        <Feature index={3} href="/docs/guide/i18n">
          <h3>内置 SEO 优化，<br className="show-on-mobile"/>请坐和放宽。</h3>
          <p className='mb-4'>Redefine 主题经过许多 SEO 优化，让你的网站更快被搜索引擎收录。无需繁琐配置。</p>
        ...
        <Feature index={9} large>
          <h3>以及更多</h3>
          <p>SEO / RSS Feed / Aplayer 播放器 / PJAX / 文章头图 / Font Awesome 6.2.1 Pro...<br/>更多功能有待探索。</p>
