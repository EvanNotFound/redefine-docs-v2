...
**Configuration Item: `global.pjax`**

PJAX allows the website to have a single-page application experience, loading new content without refreshing the page. Recommended to enable.
