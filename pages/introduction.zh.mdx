...
<div className={"dark:hidden"}>
    <Image alt={"Cover"} src={"https://github.com/EvanNotFound/hexo-theme-redefine/assets/68590232/863f7dd7-2f59-4ef4-a876-5b0a707289b1"} />
    <Image alt={"Pages"} src={"https://github.com/EvanNotFound/hexo-theme-redefine/assets/68590232/5c1f93ec-ff0d-4459-83c1-894b7538f713"} />
</div>

<div className={"hidden dark:block"}>
    <Image alt={"Cover"} src={"https://github.com/EvanNotFound/hexo-theme-redefine/assets/68590232/92427ac8-fbb8-4ce9-9807-5d0ed98484ac"} />
    <Image alt={"Pages"} src={"https://github.com/EvanNotFound/hexo-theme-redefine/assets/68590232/ee04971c-a199-448b-a91c-6f4bbe17d105"} />
